...
@section('content')
    @php
        ...
        $data_route = route('job-category.datatable');
        $store_url = route('job-category.store');
        $destroy_url = route('job-category.destroy', 11);
        $update_url = route('job-category.update', 11);
