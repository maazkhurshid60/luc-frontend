...
@section('content')
    @php
        ...
        $data_route = route('blog-category.datatable');
        $store_url = route('blog-category.store');
        $destroy_url = route('blog-category.destroy', 11);
        $update_url = route('blog-category.update', 11);
