...
@php
  ...
  $data_route = route('faq-category.datatable');
  $store_url = route('faq-category.store');
  $destroy_url = route('faq-category.destroy',11);
  $update_url = route('faq-category.update',11);
  $heading = 'Faqs Categories';
@endphp
