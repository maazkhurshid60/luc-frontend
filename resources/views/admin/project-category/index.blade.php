...
@section('content')
    @php
        ...
        $data_route = route('project-category.datatable');
        $store_url = route('project-category.store');
        $destroy_url = route('project-category.destroy', 11);
        $update_url = route('project-category.update', 11);
                                ...
                                {{-- <div class="col-md-12 form-group">
                                    ...
                                    <select class="form-control form-control-sm" name="parent_id">
                                        ...
                                        @foreach ($parentcategories as $parentcate)
                                            <option value="{{ $parentcate->id }}">{{ $parentcate->title }}</option>
                                        @endforeach
                                    </select>
                                </div> --}}
                                <div class="col-md-12 form-group">
