...
@php
  ...
  $data_route = route('testimonial.datatable');
  $store_url = route('testimonial.store');
  $destroy_url = route('testimonial.destroy',11);
  $update_url = route('testimonial.update',11);
  $heading = 'Testimonial';
@endphp
...
@section('custom-css')
	...
	<link rel="stylesheet" href="{{ asset('backend/assets/vendor_components/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css') }}">
 <style type="text/css">
   .form-control{
    margin-right: 1px;
    border-radius: 0px;
