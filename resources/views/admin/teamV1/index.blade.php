                ...
                <thead>
                  <tr>
                    @foreach ($columns as $item)
                        <th>{{ ucfirst($item) }}</th>
                    @endforeach
                    <th class="notexport text-center" >{{ __('Action') }}</th>
            ...
            @csrf
                <div class=" row">
                  ...
                  <div class="col-md-12 form-group">
                    ...
                    <textarea name="reviews" id=""  class="form-control form-control-sm"></textarea>
                  </div>
                 
                    <div class="col-md-4">
                    <label>{{ __('Image') }}</label>
                    <input type="file" name="file"  id="filez1"  class="filez1" data-max-file-size="1M" data-allowed-file-extensions="jpeg png jpg gif svg webp">
                    </div>
                    <div class="col-md-4">
...
@section('custom-css')
	...
	<link rel="stylesheet" href="{{ asset('backend_asset/assets/vendor_components/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css') }}">
 <style type="text/css">
   .form-control{
    margin-right: 1px;
    border-radius: 0px;
...
<!-- bootstrap color picker -->
<script src="{{ asset('backend_asset/assets/vendor_components/bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min.js') }}"></script>
...
var oTable = $('#dTable').DataTable({
      fixedHeader: true,
        ...
        columns: [
            ...
            { data: 'id', name: 'id' },
            { data: 'name', name: 'name' },
            { data: 'designation', name: 'sub_title' },
