            ...
            @csrf
                <div class=" row">
                  ...
                  <div class="col-md-4 form-group">
                      ...
                      <input type="text" class="form-control form-control-sm" value="#ffffff"   name="title_color">
                  </div>
                  <div class="col-md-8 form-group">
                  ...
                  <div class="col-md-4 form-group">
                      ...
                      <input type="text" class="form-control form-control-sm" value="#ffffff"  name="sub_title_color">
                  </div>
                  <div class="col-md-8 form-group">
                  ...
                  <div class="col-md-4 form-group">
                    ...
                    <input type="file" name="file"  id="filez1"  class="filez1" data-max-file-size="1M" data-allowed-file-extensions="jpeg png jpg gif svg">
                    </div>
                    <div class="col-md-12">
