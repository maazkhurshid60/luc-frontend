...
@section('content')
    @php
        $columns = ['ID', 'city', 'address', 'phone', 'email'];
        $data_route = route('address.datatable');
        $store_url = route('address.store');
        $destroy_url = route('address.destroy', 11);
        $update_url = route('address.update', 11);
        $heading = 'Address';
    @endphp
                        ...
                        <form method="POST" id="addForm" enctype="multipart/form-data"
                            ...
                            <div class=" row">
                                ...
                                <div class="col-md-12 form-group">
                                    ...
                                    <textarea name="map" id="" class="form-control form-control-sm"></textarea>
                                </div>
                                <div class="col-md-12">
