...
@section('content')
    <div class="main">
        <div class="main">
            ...
            <div class="container-fluid afcon--hero-section careers-bg d-flex flex-column justify-content-center myb-40">
                <div class="container">
                    <div class="row">
                        <h1 class="head--1 wht--clr text-center">Our Reach</h1>
                        <span class="body-txt1 bread-crumb text-center"><a href="../index.html"
                                class="body-txt1 wht--clr text-decoration-none">Home</a> / Our Reach</span>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="project-archive-filters pb-5 d-flex justify-content-end gap-4">
                            <div class="dropdown position-relative">
                                ...
                                <img src="../assets/icons/location.svg" alt="" class="position-absolute "
                            ...
                            <div class="dropdown position-relative">
                                ...
                                <img src="../assets/icons/funel-bars.svg" alt="" class="position-absolute "
                        ...
                        <div class="project-content-wrapper d-flex flex-md-row flex-column mb-4 gap-md-0 gap-4">
                            <div class="project-img-wrap">
                                <a href="project-details.html"><img src="../assets/images/project-img1.webp" alt=""
                                        class="project--img"></a>
                            </div>
                            <div
                                ...
                                <h3 class="head--3 secondary--clr mb-lg-4 mb-2 text-md-start text-center">PMR — Online
                                    Platform &
                                    Responsive Website Design</h3>
                                <p class="body-txt1 txt--clr mb-lg-4 mb-2 text-md-start text-center">Less Doing, More
                                    Living was a
                                ...
                                <span class="fit-content "><a href="project-details.html"
                                        ...
                                        Case Study<img src="../assets/icons/arrow1.svg" alt=""
                                            class="ms-2"></a></span>
                            </div>
                        </div>
                        <div class="project-content-wrapper d-flex flex-md-row-reverse flex-column mb-4 gap-md-0 gap-4">
                            <div class="project-img-wrap">
                                <a href="project-details.html"><img src="../assets/images/project-img2.webp"
                                        alt="" class="project--img"></a>
                            </div>
                            <div
                        ...
                        <div class="project-content-wrapper d-flex flex-md-row flex-column gap-md-0 gap-4">
                            <div class="project-img-wrap">
                                <a href="project-details.html"><img src="../assets/images/project-img3.webp"
                                        alt="" class="project--img"></a>
                            </div>
                            <div
                                class="project-details-wrap d-flex flex-column justify-content-center align-items-md-start align-items-center ps-md-4 ps-0">
