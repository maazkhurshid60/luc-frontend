    ...
    <main class="wrapper">
        <section class="intro-section click-up">
            <div class="intro-content">
                ...
                <p class="section-content">In ClickUp, Structure is a way to organize your work into a hierarchy of
                    Spaces, Folders, Lists, and Tasks. This hierarchy provides a visual and organized way to manage
                    complex projects by breaking them down into manageable components, facilitating better task tracking
                    and management.</p>
