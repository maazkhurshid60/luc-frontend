    ...
    <main class="wrapper">
            ...
            <div class="intro-content">
                ...
                <div>
                    ...
                    <div class="center-wrapper-mobile">
                        <h1 class="platform-availability">Available on both Google Play and App Store </h1>
                        <div class="icon">
                    ...
                    <div class="link-wrapper"> <a href="https://example.com" class="section-link-balancer">Visit
                            Website</a></div>
                </div>
        ...
        <section class="core-features ">
            ...
            <div class="core-features-description">
                ...
                <div class="feature-container">
                    <div class="feature-heading">
                        <img src="{{ asset('assets/img/portfolio/balancer/icon-Import-Export.svg') }}" alt="icon">
