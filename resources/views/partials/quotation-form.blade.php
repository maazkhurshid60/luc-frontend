            ...
            <div class="col-12 bg-white  request-quote-wrapper ">
                ...
                <form class="row g-4" id="quoteForm">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control req-quote-input" id="nameinput" placeholder="{{ __('lang.FULL_NAME') }}">
                    </div>
                    <div class="col-md-6">
                        <label for="inputEmail4" class="form-label mb-2 body-txt2 secondary--clr">{{ __('lang.EMAIL') }}</label>
                        <input type="email" class="form-control req-quote-input" id="inputEmail4" placeholder="{{ __('lang.EMAIL_ADDRESS') }}">
                    </div>
                    <div class="col-12">
                        <label for="subjectsInput" class="form-label mb-2 body-txt2 secondary--clr">{{ __('lang.SUBJECTS') }}</label>
                    ...
                    <div class="col-12">
                        ...
                        <textarea class="form-control req-quote-input" id="textArea" rows="3" placeholder="{{ __('lang.TELL_US_ABOUT_PROJECT') }}"></textarea>
                    </div>
                    <div class="col-12 d-flex justify-content-center">
                        <button type="submit" class=" primary-btn req-quote-sub wht--clr">{{ __('lang.SUBMIT') }}<img src="{{ asset('assets/frontend/icons/arrow1.svg') }}" alt="" class="ms-3"></button>
                    </div>
                </form>                
            </div>
        </div>
