    ...
    <div class="container">
        ...
        <div class="row justify-content-center g-4">
                ...
                <div class="our-team-content-wrapper">
                    ...
                    <div class="our-team-details d-flex flex-column justify-content-center align-items-center p-4">
                        <div class="name-des col-lg-6 col-12">
                            <h3 class="head--3 secondary-clr mb-3 text-center">Phillip Dorwart</h3>
            ...
            <div class="our-team-card-wrapper d-flex flex-column justify-content-center ">
                <div class="our-team-content-wrapper">
                    <div class="our-team-img d-flex justify-content-center">
                        <img src="{{ asset('assets/frontend/images/our-team-img2.webp') }}" alt=""
                            class="img-fluid our-team--img" />
                    </div>
                    <div class="our-team-details d-flex flex-column justify-content-center align-items-center p-4">
                        <div class="name-des col-lg-6 col-12">
            ...
            <div class="our-team-card-wrapper d-flex flex-column justify-content-center ">
                <div class="our-team-content-wrapper">
                    <div class="our-team-img d-flex justify-content-center">
                        <img src="{{ asset('assets/frontend/images/our-team-img3.webp') }}" alt=""
                            class="img-fluid our-team--img" />
                    </div>
                    <div class="our-team-details d-flex flex-column justify-content-center align-items-center p-4">
                        <div class="name-des col-lg-6 col-12">
            ...
            <div class="our-team-card-wrapper d-flex flex-column justify-content-center ">
                <div class="our-team-content-wrapper">
                    <div class="our-team-img d-flex justify-content-center">
                        <img src="{{ asset('assets/frontend/images/our-team-img4.webp') }}" alt=""
                            class="img-fluid our-team--img" />
                    </div>
                    <div class="our-team-details d-flex flex-column justify-content-center align-items-center p-4">
                        <div class="name-des col-lg-6 col-12">
            ...
            <div class="our-team-card-wrapper d-flex flex-column justify-content-center ">
                <div class="our-team-content-wrapper">
                    <div class="our-team-img d-flex justify-content-center">
                        <img src="{{ asset('assets/frontend/images/our-team-img5.webp') }}" alt=""
                            class="img-fluid our-team--img" />
                    </div>
                    <div class="our-team-details d-flex flex-column justify-content-center align-items-center p-4">
                        <div class="name-des col-lg-6 col-12">
