    ...
    <div
        ...
        <div style="padding: 0px;">
            <p
                ...
                Dear {{$name}},<br><br>
                Thank you for reaching out to us! We have received your query and appreciate your interest in AFCON Group of Compnies.<br><br>
        ...
        <div style="text-align: center; padding: 30px 0;">
            <a href="https://facebook.com" style="margin: 0 10px; text-decoration: none;">
                <img src="{{asset('assets/frontend/icons/e_temp-fb.svg')}}" alt="Facebook" width="32" style="display: inline-block;">
            </a>
            <a href="https://linkedin.com" style="margin: 0 10px; text-decoration: none;">
                <img src="{{asset('assets/frontend/icons/e_temp-ln.svg')}}" alt="LinkedIn" width="32" style="display: inline-block;">
            </a>
            <a href="https://twitter.com" style="margin: 0 10px; text-decoration: none;">
                <img src="{{asset('assets/frontend/icons/e_temp-X.svg"')}} alt="Twitter" width="32" style="display: inline-block;">
            </a>
            <a href="https://instagram.com" style="margin: 0 10px; text-decoration: none;">
                <img src="{{asset('assets/frontend/icons/e_temp-in.svg')}}" alt="Instagram" width="32" style="display: inline-block;">
            </a>
            <a href="https://youtube.com" style="margin: 0 10px; text-decoration: none;">
                <img src="{{asset('assets/frontend/icons/e_temp-yt.svg')}}" alt="YouTube" width="32" style="display: inline-block;">
            </a>
        </div>
